...
#ifndef TRANSPORT_TRANSPORT_PORT_PARAMETERS_H_
#define TRANSPORT_TRANSPORT_PORT_PARAMETERS_H_

namespace transport
{

/**
 * Class PortParameters, to define the port parameters and gains related with the TRANSPORT protocol.
 * @ingroup TRANSPORT_ATTRIBUTES_MODULE
 */
class PortParameters
{
public:
    PortParameters()
        : portBase(7400), domainIDGain(250), participantIDGain(2), offsetd0(0), offsetd1(10), offsetd2(1), offsetd3(11)
    {
    }
     ...
     *
     * @param domainId Domain ID.
     * @param TRANSPORTParticipantID Participant ID.
     * @return Unicast port
     */
    inline uint32_t getUnicastPort(
        uint32_t domainId,
        uint32_t TRANSPORTParticipantID) const
    {
        uint32_t port = portBase + domainIDGain * domainId + offsetd1 + participantIDGain * TRANSPORTParticipantID;
...
#endif /* TRANSPORT_TRANSPORT_PORT_PARAMETERS_H_ */
